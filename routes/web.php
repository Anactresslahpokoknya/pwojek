...
Route::post('siswa/edit/{nisn}',[AdminController::class,'logic']);
Route::get('petugas/edit/{id_petugas}',[AdminController::class,'editp']);
Route::post('petugas/edit/{id_petugas}',[AdminController::class,'logicp']);
Route::get('kelas/edit/{id_kelas}',[AdminController::class,'editk']);
Route::post('kelas/edit/{id_kelas}',[AdminController::class,'logick']);
Route::get('spp/edit/{id_spp}',[AdminController::class,'editspp']);
Route::post('spp/edit/{id_spp}',[AdminController::class,'logicspp']);
Route::get('pembayaran/edit/{id_pembayaran}',[AdminController::class,'editgcc']);
Route::post('pembayaran/edit/{id_pembayaran}',[AdminController::class,'logicgcc']);